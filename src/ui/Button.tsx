 ...
 * внешний вид кнопки теперь берётся из текущего этапа синтеза через
 * `ActStage` (`--color-accent`/`--color-on-accent` и т.д. каскадом из
 * `data-stage`), а не из закона, под которым жил конкретный экран в
 * снесённом мире актов.
 */
...
export interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
   ...
   * вид кнопки задаёт текущий этап (`ActStage`), а не закон экрана. */
  law?: Law;
