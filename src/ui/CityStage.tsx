...
const SCENE_ART: Partial<Record<StepKey, SceneArt>> = {
  ...
  epiphany: { file: 'evidence-bay.webp', opacity: 0.48, position: 'center top' },
  tool1: { file: 'evidence-bay.webp', opacity: 0.34, position: 'center top' },
  ...
  message: { file: 'offer-workbench.webp', opacity: 0.34, position: 'center top' },
  formulas: { file: 'traffic-lab-interior.webp', opacity: 0.3, position: 'center top' },
  money: { file: 'own-line-kit.webp', opacity: 0.34, position: 'center top' },
  ...
  promises: { file: 'own-line-kit.webp', opacity: 0.36, position: 'center top' },
  assembly: { file: 'landing-assembly-line.webp', opacity: 0.4, position: 'center top' },
  catharsis: { file: 'traffic-lab-exterior.webp', opacity: 0.34, position: 'center 58%' },
